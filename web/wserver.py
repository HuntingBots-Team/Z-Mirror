...
@app.route("/")
def homepage():
    return "<h1>Visit my channel <a href='https://telegram.me/TGHThingLeech_bot'>@TGHThingLeech_bot</a>on Telegram By <a href='https://telegram.me/TGHLeechSupport'>@TGHLeechSupport</a></h1>"
